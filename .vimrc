...
" CtrlP is actually ctrl-p
let g:ctrlp_map = '<c-p>'
let g:ctrlp_cmd = 'CtrlP'
let g:ctrlp_working_path_mode = ''
let g:ctrlp_root_markers = ['tags']
set wildignore+=*.so,*.zip,*.bin,*/dist/*
let g:ctrlp_user_command = 'find ./ -type f \( -iname \*.cpp -o iname \*.h \)'
...
" open tags in a vertical split
" https://stackoverflow.com/questions/33600608/how-to-cause-ctags-to-show-tag-definition-on-vertical-split-without-opening-a-ne/33603586#33603586
